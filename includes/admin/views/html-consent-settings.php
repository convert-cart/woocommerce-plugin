...
<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <textarea id="checkout_html" name="checkout_html" rows="5" cols="50" class="large-text code"><?php echo esc_textarea( $checkout_html ); ?></textarea>

        <h2><?php esc_html_e( 'Registration Page HTML', 'woocommerce_cc_analytics' ); ?></h2>
        <textarea id="registration_html" name="registration_html" rows="5" cols="50" class="large-text code"><?php echo esc_textarea( $registration_html ); ?></textarea>

        <h2><?php esc_html_e( 'My Account Page HTML', 'woocommerce_cc_analytics' ); ?></h2>
        <textarea id="account_html" name="account_html" rows="5" cols="50" class="large-text code"><?php echo esc_textarea( $account_html ); ?></textarea>
